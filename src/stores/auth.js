...
export const useAuthStore = defineStore('auth', () => {
    ...
    return {
        user, admin, unlockedServers, currentServer, loading, initialized,
        canViewLogs, canViewRemoved, canViewGAActions, canManageServers, isAuthenticated, hasUnlockedServers,
        initFromToken, initFromStorage, refreshSessionStatus, unlockServer, loadAdminData, switchServer, isServerUnlocked, clearAuth, logout
    }
})
