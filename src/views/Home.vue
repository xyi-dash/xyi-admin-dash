...
<template>
    <div class="flex flex-col gap-4">
        ...
        <template v-else-if="admin">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4" style="align-items: start">
                <div class="card">
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex justify-between items-center h-8 border-b border-surface-200 dark:border-surface-700">
                            <span class="text-muted-color">Appointed By</span>
                            <span class="font-medium">{{ admin.appointed_by || 'Unknown' }}</span>
                        </div>
                        <div class="flex justify-between items-center h-8 border-b border-surface-200 dark:border-surface-700">
                            <span class="text-muted-color">Appointed Date</span>
                            <span class="font-medium">{{ admin.appointed_date || 'Unknown' }}</span>
                        </div>
                        <div class="flex justify-between items-center h-8 border-b border-surface-200 dark:border-surface-700">
                            <span class="text-muted-color">Last Online</span>
                            <span class="font-medium">{{ admin.last_online || 'Never' }}</span>
                        </div>
                        <div class="flex justify-between items-center h-8">
                            <span class="text-muted-color">Status</span>
                            <Tag :severity="admin.is_confirmed ? 'success' : 'warn'" size="small">
                                {{ admin.is_confirmed ? 'Confirmed' : 'Unconfirmed' }}
                            </Tag>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="font-semibold text-lg">Playtime</span>
                    </div>
                    <div class="flex flex-col gap-3">
                        <div class="flex justify-between items-center h-8 border-b border-surface-200 dark:border-surface-700">
                        ...
                        <div class="flex justify-between items-center h-8 border-b border-surface-200 dark:border-surface-700">
                            <span class="text-muted-color">Yesterday</span>
                            <span class="font-medium">{{ admin.playtime?.yesterday || '00:00' }}</span>
                        </div>
                        <div class="flex justify-between items-center h-8 border-b border-surface-200 dark:border-surface-700">
                            <span class="text-muted-color">Day Before</span>
            ...
            <div class="card">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <span class="font-semibold text-lg">Statistics</span>
                </div>
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <div class="flex-1 text-center p-4 bg-surface-100 dark:bg-surface-800 rounded-lg">
                        ...
                        <div class="text-muted-color text-sm">Reports Answered</div>
                    </div>
                    <div class="flex-1 text-center p-4 bg-surface-100 dark:bg-surface-800 rounded-lg">
                        ...
                        <div class="text-muted-color text-sm">Reputation</div>
                    </div>
                </div>
            </div>
        </template>
        ...
        <div v-else class="card text-center py-8">
            ...
            <p class="text-muted-color">Could not retrieve admin information</p>
        </div>
    </div>
</template>
