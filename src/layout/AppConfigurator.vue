            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-between">
                    <button
                        ...
                        class="border-none w-5 h-5 rounded-full p-0 cursor-pointer"
                        :style="{
                            backgroundColor: primaryColor.name === 'noir' ? 'var(--text-color)' : primaryColor.palette['500'],
                            outline: layoutConfig.primary === primaryColor.name ? '2px solid var(--p-primary-color)' : 'none',
                            outlineOffset: '2px'
                        }"
                    ></button>
                </div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-between">
                    <button
                        ...
                        :style="{
                            ...
                            outline: (layoutConfig.surface ? layoutConfig.surface === surface.name : isDarkTheme ? surface.name === 'zinc' : surface.name === 'slate') ? '2px solid var(--p-primary-color)' : 'none',
                            outlineOffset: '2px'
                        }"
                    ></button>
                </div>
