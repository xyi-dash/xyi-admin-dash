...
const savedConfig = JSON.parse(localStorage.getItem('layout_config') || '{}');
...
watch(layoutConfig, (cfg) => localStorage.setItem('layout_config', JSON.stringify(cfg)), { deep: true });

if (layoutConfig.darkTheme) document.documentElement.classList.add('app-dark');

// this object holds the entire ui state. touch it wrong and everything breaks.
